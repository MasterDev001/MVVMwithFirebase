...
import com.example.mvvmwithfirebase.util.SharedPrefConstants
...
class AuthRepositoryImpl(
    ...
    override fun storeSession(id: String, result: (User?) -> Unit) {
        database.collection(FireStoreCollection.USER).document(id).get().addOnCompleteListener {
            if (it.isSuccessful) {
        ...
        }.addOnFailureListener { result.invoke(null) }
    }
